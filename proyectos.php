            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto pb-5">
                    <div class="col-12 p-0">
                        ...
                        <img src="css/imgenes/abmclientes.png" alt="ABM CLIENTES" class="img-fluid">
                        <h2>ABM CLIENTES</h2>
            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto pb-5">
                    <div class="col-12 p-0">
                        ...
                        <img src="css/imgenes/abmventas.png" alt="ABM CLIENTES" class="img-fluid">
            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto pb-5">
                    <div class="col-12 p-0">
                        ...
                        <img src="css/imgenes/proyecto-integrador.png" alt="ABM CLIENTES" class="img-fluid">
